...
struct UserEditor: View {
    ...
    var editUser: User?
    var iphone = ["iPhone 12", "iPhone 12 Pro","iPhone 12 Pro Max", "iPhone 11", "iPhone 11 Pro", "iPhone 11 Pro Max", "iPhone XS", "iPhone XS Max", "iPhone X", "iPhone XR", "iPhone SE 2th", "iPhone SE", "iPhone 8","iPhone 8 Plus", "iPhone 7", "iPhone 7 Plus", "iPhone 6s", "iPhone 6s Plus"]
    @State private var selectedDecive = "iPhone 12"
    var body: some View {
        Form{
